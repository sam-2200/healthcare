  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Sam", style: TextStyles.h1Style),
      ],
    ).p16;
  }
      ...
      children: <Widget>[
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _categoryCard("Covid-19 Tests", "90 + Labs",
                  color: LightColor.green, lightColor: LightColor.lightGreen),
              _categoryCard("Pharmacist", "200+ Stores",
                  color: LightColor.skyBlue, lightColor: LightColor.lightBlue),
              _categoryCard("Hospitals", "360+ Hospitals",
                  color: LightColor.orange, lightColor: LightColor.lightOrange),
              _categoryCard("Health Checkups", "260+ Clinics",
                  color: LightColor.purpleLight,
                  lightColor: LightColor.purpleExtraLight)
            ],
          ),
        ),
      ],
